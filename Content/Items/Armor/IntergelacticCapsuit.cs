...
namespace CalamityClickers.Content.Items.Armor
{
    ...
    public class RenderPlayer : ModPlayer
    {
        ...
        public override void DrawEffects(PlayerDrawSet drawInfo, ref float r, ref float g, ref float b, ref float a, ref bool fullBright)
        {
            ...
            if (modPlayer.intergelacticClicker != null && Main.myPlayer == drawPlayer.whoAmI && CalamityUtils.Calamity(drawPlayer).wearingRogueArmor)
            {
            ...
            else if (modPlayer.intergelacticClicker != null && Main.myPlayer == drawPlayer.whoAmI && IsHoldingAnItemWhichRequiresThemToSeeNearbyTiles(drawPlayer))
            {
            ...
            else if (modPlayer.intergelacticClicker != null && Main.myPlayer == drawPlayer.whoAmI && drawPlayer.CalClicker().HideAsteroids)
            {
                IsHoldingAnItemWhichRequiresThemToSeeNearbyTiles(drawPlayer);
                intergelacticRenderAlpha = 0.1f;
            }
    ...
    public class PostDrawLayer : PlayerDrawLayer
    {
        ...
        protected override void Draw(ref PlayerDrawSet info)
        {
            ...
            if ((info.shadow == 0f) && modPlayer.intergelacticClicker != null && modPlayer2.astralRockRenderData != null)
            {
